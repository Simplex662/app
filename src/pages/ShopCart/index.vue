      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart,index) in cartInfoList" :key="index">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked="cart.isChecked" @click="updataChecked(cart,$event)">
          </li>
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" :value="cart.skuNum" minnum="1" class="itxt" @change="handler('other',$event.target.value * 1,cart)">
          ...
          <li class="cart-list-con7">
            <a href="#none" class="sindelet" @click="deleteCartItem(cart)">删除</a>
            <br>
            <a href="#none">移到收藏</a>
          </li>
        </ul>
  ...
  export default {
    ...
    methods:{
      ...
      async deleteCartItem(cart) {
        try {
          await this.$store.dispatch('shopCart/deleteCartItem', cart.skuId);
          this.getCart();
        } catch (e) {
          alert(e.message)
        }
      ...
      async updataChecked(cart, event) {
        try {
          ...
          await this.$store.dispatch("shopCart/updataCartCheckStatus", {skuId: cart.skuId, isChecked});
          this.getCart();
        }catch (e) {
          alert(e.message)
        }
