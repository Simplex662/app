...
<script>
  ...
  export default {
    ...
    computed:{
        ...mg('detail',{categoryView:'categoryView',skuInfo:'skuInfo',spuSaleAttrList:'spuSaleAttrList'}),
      skuImageList(){
          /*
            这里的 skuInfo.skuImageList 不能够直接传入子路由 因为 再Dom渲染时 vuex 的数据可能没有请求
            传入组件的参数为 '0'或者 undefined 导致报错
          */
